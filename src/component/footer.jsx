  ...
  return (
    <footer>
        <section className='footer--one'>
            <div className='footer--one--div' id='firstft'>
            ...
            <div className='footer--one--div' id='secondft'>
                <h3>Delivery Time</h3>
            ...
            <div className='footer--one--div' id='thirdft'>
                <h3>Contact</h3>
            ...
            <div className='footer--one--div' id='fourthft'>
                <h3>Newsletter</h3>
